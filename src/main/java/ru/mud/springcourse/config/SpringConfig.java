package ru.mud.springcourse.config;
...
@Configuration
@ComponentScan("ru.mud.springcourse")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableJpaRepositories("ru.mud.springcourse.repositories")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.mud.springcourse.models");
    ...
    public PlatformTransactionManager transactionManager() {
        //Создаем JPA менеджер (почти как в 1 варианте)
        JpaTransactionManager transactionManager = new JpaTransactionManager();
        //Устанавливаем ему менеджер фактори
